        ...
        <div className={styles["form-box-register"]}>
          <div className={styles["form-value"]}>
            <form action="">
              ...
              <FontAwesomeIcon className={styles["font-awesome"]} icon={faEnvelope} />
                <Input
                  label="Email"
                  reverse={true}
                  ref={emailInputRef}
              ...
              <div className={styles["inputbox"]}>
              <FontAwesomeIcon className={styles["font-awesome"]} icon={faCheck} />
              <Input
              ...
              <p>Already have an account? <a onClick={loginHandler} href="/login">Login</a></p>
              </div>
            </form>
          </div>
        </div>
